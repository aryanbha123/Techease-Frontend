...
export default function Contact() {
    return (
        <div>
            <div class="px-5   bg-white my-6 font-[sans-serif]">
                ...
                <div class="grid lg:grid-cols-3 items-start justify-items-stretch gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
                    ...
                    <div class="bg-black rounded-lg p-6 h-full max-lg:order-1">
                    ...
                    <div class="p-4 lg:col-span-2">
                        <form>
                            ...
                            <button type="button"
                                class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-[#0149ad]">
