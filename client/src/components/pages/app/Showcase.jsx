  ...
  const projects = [
    {
      ...
      content: 'Interactive quizzes to help you strengthen your knowledge across various subjects and skills.',
      image: 'https://cdn.tailgrids.com/2.0/image/marketing/images/portfolio/portfolio-01/image-01.jpg'
    },
    {
      id: 2,
      title: 'Roadmaps',
      content: 'Detailed learning paths to guide you step-by-step in mastering your desired field or skill.',
      image: 'https://cdn.tailgrids.com/2.0/image/marketing/images/portfolio/portfolio-01/image-02.jpg'
    },
    {
      id: 3,
      title: 'Mentorship',
      content: 'One-on-one or group mentoring sessions with industry experts to accelerate your growth.',
      image: 'https://cdn.tailgrids.com/2.0/image/marketing/images/portfolio/portfolio-01/image-03.jpg'
    },
    {
      id: 4,
      title: 'Jobs & Hackathon',
      content: 'Professional design services, including logos, business cards, and branding to elevate your business.',
        ...
        <div className='md:flex-nowrap flex-wrap flex gap-5'>
          {projects
            .map(project => (
              ...
              //   </div>
              // </div>
              <Card description={project.content} heading={project.title} index={project.id} />
            ))}
        </div>
      </div>
    </section>
