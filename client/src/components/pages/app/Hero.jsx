...
export default function Hero() {
  return (
    <>
      <section className="relative py-14 overflow-hidden bg-gradient-to-b from-indigo-50 via-transparent to-indigo-50">
        <div className="text-gray-900 w-[90vw] mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          {/* Announcement Banner */}
          <div className="flex justify-center">
            <a
              className="group inline-flex items-center border border-gray-600 -100 p-1 ps-4 rounded-full shadow-md focus:outline-none focus:bg-[#0149ab] -100"
              href="../techease-launch.html"
            >
          ...
          <div className="max-w-3xl text-center mx-auto">
            ...
            Prepare smarter with our curated quizzes, mock tests, and performance analysis tools. Build confidence and crack your dream placement!
            </p>
          </div>
