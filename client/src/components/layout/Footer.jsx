...
import { EmailSvg } from '../utils/Svg'
          ...
          <div>
            <ul class='pb-3 pt-10 space-y-4'>
              <li class='flex items-center'>
                ...
                <a href='javascript:void(0)' class='text-gray-900 text-sm  ml-4'>
          ...
          <div className='py-7 border-t border-gray-200'>
            <div className='flex items-center justify-center flex-col lg:justify-between lg:flex-row'>
              ...
              <div className='flex mt-4 space-x-4 sm:justify-center lg:mt-0 '>
                ...
                >
                  <svg
                    className='w-[1.25rem] h-[1.125rem] text-gray-900'
                    viewBox='0 0 15 15'
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                  >
                ...
                >
                  <svg
                    className='w-[1rem] h-[1rem] text-gray-900'
                    viewBox='0 0 13 12'
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                  >
                ...
                >
                  <svg
                    className='w-[1.25rem] h-[0.875rem] text-gray-900'
                    viewBox='0 0 16 12'
                    fill='#fff'
                    xmlns='http://www.w3.org/2000/svg'
                  >
