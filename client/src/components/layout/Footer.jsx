          ...
          <div className='grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8'>
            <div className='col-span-full mb-10 lg:col-span-2 lg:mb-0'>
              ...
              <p className='text-sm text-gray-500'>
                Email : techeaseportal@gmail.com
              </p>
              <p className='text-sm text-gray-500'>Contact : 07017244278</p>
              <p></p>
            </div>
            <div></div>
            ...
            <div className='lg:mx-auto text-left'>
              <h4 className='text-lg text-gray-900 font-medium mb-7'>Updates</h4>
              <ul className='text-sm  transition-all duration-500'>
                <li className='mb-6'>
                  <a
                    href='javascript:;'
          ...
          <div className='py-7 border-t border-gray-200'>
            <div className='flex items-center justify-center flex-col lg:justify-between lg:flex-row'>
              <span className='text-sm text-gray-500 '>
                ©<a href='https://pagedone.io/'>Techease</a> 2025 , All rights
                reserved.
              </span>
              <div className='flex mt-4 space-x-4 sm:justify-center lg:mt-0 '>
                <a
                  href='javascript:;'
                  className='w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-[#0149ad] go-600'
                >
                  <svg
